...
\usepackage[
  mainczech, %% By using `czech` or `slovak` as the main locale
...
\thesissetup{
    ...
    author        = Pepa Novák,
    gender        = m,
    advisor       = Josef Novotný,
    title         = {Poznej FI!},
    TeXtitle      = {Poznej FI},
    keywords      = {Fakulta informatiky, Masarykova univerzita, Spolek přátel severské zvěře, zvěřinec},
    TeXkeywords   = {Fakulta informatiky, Masarykova univerzita, Spolek přátel severské zvěře, zvěřinec},
